...
source1 = 'C:\E\PhD\NAFLD project\Dry lab\Clinical data(3 images)\MT stea all\'; % all 
source2 = 'C:\E\PhD\NAFLD project\Dry lab\Clinical data(3 images)\MT binary\'; %processed binary
